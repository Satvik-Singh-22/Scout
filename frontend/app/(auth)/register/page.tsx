...
export default function RegisterPage() {
  ...
  const inputClasses = "w-full px-4 py-3 rounded-xl text-sm text-white placeholder-gray-500 transition-all duration-200 outline-none focus:ring-2 focus:ring-emerald-500/50"
  const inputStyle = {
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative w-full max-w-lg transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
      >
        {/* Glassmorphic card */}
        <div
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h1 id="register-heading" className="text-2xl font-bold text-white tracking-tight">
              Create your account
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Team */}
            <div>
              <label htmlFor="register-team" className="block text-sm font-medium text-gray-300 mb-1.5">
                Team
              </label>
              {teamsLoading ? (
                <div
              ...
              <div className="grid grid-cols-3 gap-2">
                {roleOptions.map(option => {
                  ...
                  return (
                    ...
                    >
                      <span className={`block text-sm font-medium ${isSelected ? 'text-emerald-400' : 'text-gray-300'}`}>
                        {option.label}
                      </span>
                      <span className={`block text-[10px] mt-0.5 leading-tight ${isSelected ? 'text-emerald-500/70' : 'text-gray-500'}`}>
                        {option.description}
                      </span>
                      {isSelected && (
                    ...
                    >
                      <span className="flex items-center gap-2">
                        ...
                        <span>
                          ...
                          <span className={`block text-[10px] ${isSelected ? 'text-emerald-500/70' : 'text-gray-500'}`}>
                            {option.description}
                          </span>
                        </span>
                      </span>
            ...
            <button
              ...
              type="submit"
              disabled={loading}
              className="w-full text-white font-semibold py-3 rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:ring-offset-2 focus:ring-offset-transparent hover:shadow-lg active:scale-[0.98] mt-2"
              style={{
                background: 'linear-gradient(135deg, #10b981 0%, #059669 100%)',
